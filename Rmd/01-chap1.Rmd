...
Despite some modest successes at explaining the complex response properties of V2 (Lee et al., 2008; Olshausen et al., 2001) subsequent findings (Pietro Berkes et al., 2009; Willmore et al., 2011) have challenged the primacy of coding efficiency for explaining representations in higher visual areas. Anatomical evidence indicates that information redundancy likely goes up visual information carried by the 106 axons from retinal ganglion cells relay visual information to the ~109 neurons in primary visual cortex (Figure \@ref(fig:channelcoding)) (Barlow, 2001; Felleman and Van Essen, 1991). In this case, instead of information redundancy going down as would be predicted by efficient coding, the increase in redundancy must be explained by something else.
