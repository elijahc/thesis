...
In Chapter [3](#ch:jsr) we demonstrate ANN models as tool for decoding sleep state in real-time using only the signals available from  intracranial DBS electrodes implanted in the basal ganglia of PD patients.
