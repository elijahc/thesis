...
# Predicting sleep state in human PD patients^[Extra footnote] {#ch3:jsr}

* The contents of this chapter are available in [Inferring sleep stage from local field potentials recorded in the subthalamic nucleus of Parkinson’s patients.](https://doi.org/10.1111/jsr.12806)^[This chapter was previously published in [@Christensen:2019ik] Journal of Sleep Research and is included with permission from the copyright holder]
...
This study was approved by the Institutional Review Board of the University of Minnesota, where the surgical and recording procedures were performed. All consented study subjects (n = 9) carried a diagnosis of idiopathic PD (Figure \@ref(fig:jsr1) A). Subjects were unilaterally implanted in STN with a quadripolar DBS electrode (model #3389: Medtronic Inc., Fridley, MN), per routine surgical protocol (Abosch et al., 2012). Experimental details for the recording setup have been previously published (Thompson et al., 2018). Basic characterization of these data was previously reported in Thompson et al., 2018.

```{r jsr1, echo=FALSE, message=FALSE, fig.align='center', out.width = '75%', fig.cap="(A) Demographic data and sleep stage characteristics for Parkinson’s disease subjects participating in this study (n = 9). Percent improvement in PD reflects the change in the Unified Parkinson’s Disease Rating Scale (UPDRS) motor scale before and after DBS surgery.(B)	Hypnograms from four representative subjects in this study, indicative of common sleep architecture deficits reported for individuals with PD. (C)	Distribution of frequency band power contribution to sleep stage for all subjects."}

knitr::include_graphics("img/jsr_fig1_final.png")

```

### Signal processing of local field potentials
